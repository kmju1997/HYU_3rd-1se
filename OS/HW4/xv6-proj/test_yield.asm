...
main(int argc, char *argv[])
{
   ...
   f:	e8 b6 02 00 00       	call   2ca <fork>
        if (pid > 0) {
  14:	83 f8 00             	cmp    $0x0,%eax
  17:	7e 26                	jle    3f <main+0x3f>
{
    int pid;
    int i;
    ...
    for (i = 0; i < CNT_CHILD; i++) {
  19:	83 eb 01             	sub    $0x1,%ebx
  1c:	75 f1                	jne    f <main+0xf>
  1e:	66 90                	xchg   %ax,%ax
            exit();
        }
    }
    ...
    for (i = 0; i < CNT_CHILD; i++) {
        wait();
  20:	e8 b5 02 00 00       	call   2da <wait>
  25:	e8 b0 02 00 00       	call   2da <wait>
  2a:	e8 ab 02 00 00       	call   2da <wait>
  2f:	90                   	nop
  30:	e8 a5 02 00 00       	call   2da <wait>
  35:	e8 a0 02 00 00       	call   2da <wait>
    }

    exit();
  3a:	e8 93 02 00 00       	call   2d2 <exit>
  3f:	90                   	nop
    for (i = 0; i < CNT_CHILD; i++) {
        pid = fork();
        if (pid > 0) {
  ...
  42:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
        if (pid > 0) {
            ...
            // child]
            char *args[3] = {"echo", "echo is executed!", 0};
  49:	c7 44 24 14 c6 07 00 	movl   $0x7c6,0x14(%esp)
  50:	00 
  51:	c7 44 24 18 cb 07 00 	movl   $0x7cb,0x18(%esp)
  58:	00 
  59:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  60:	00 
            sleep(1);
  61:	e8 04 03 00 00       	call   36a <sleep>
            exec("echo", args);
  66:	8d 44 24 14          	lea    0x14(%esp),%eax
  6a:	89 44 24 04          	mov    %eax,0x4(%esp)
  6e:	c7 04 24 c6 07 00 00 	movl   $0x7c6,(%esp)
  75:	e8 90 02 00 00       	call   30a <exec>
            printf(1, "exec failed!!\n");
  7a:	c7 44 24 04 dd 07 00 	movl   $0x7dd,0x4(%esp)
  81:	00 
  82:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  89:	e8 d2 03 00 00       	call   460 <printf>
            exit();
  8e:	e8 3f 02 00 00       	call   2d2 <exit>
        } else {
            printf(1, "fork failed!!\n");
  93:	c7 44 24 04 ec 07 00 	movl   $0x7ec,0x4(%esp)
  9a:	00 
  9b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  a2:	e8 b9 03 00 00       	call   460 <printf>
            exit();
  a7:	e8 26 02 00 00       	call   2d2 <exit>
  ac:	66 90                	xchg   %ax,%ax
  ae:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f9:	0f b6 92 02 08 00 00 	movzbl 0x802(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 58f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 591:	b8 fb 07 00 00       	mov    $0x7fb,%eax
...
free(void *ap)
{
 ...
 651:	a1 78 0a 00 00       	mov    0xa78,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 697:	89 10                	mov    %edx,(%eax)
  freep = p;
 699:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6bf:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 6c2:	a3 78 0a 00 00       	mov    %eax,0xa78
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 1d 78 0a 00 00    	mov    0xa78,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 729:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 72b:	3b 15 78 0a 00 00    	cmp    0xa78,%edx
...
morecore(uint nu)
{
 ...
 74a:	e8 13 fc ff ff       	call   362 <sbrk>
  if(p == (char*)-1)
 ...
 75d:	e8 ee fe ff ff       	call   650 <free>
  return freep;
 762:	8b 15 78 0a 00 00    	mov    0xa78,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 784:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 787:	89 15 78 0a 00 00    	mov    %edx,0xa78
      return (void*)(p + 1);
 ...
 79c:	eb e9                	jmp    787 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 79e:	c7 05 78 0a 00 00 7c 	movl   $0xa7c,0xa78
 7a5:	0a 00 00 
    base.s.size = 0;
 7a8:	ba 7c 0a 00 00       	mov    $0xa7c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7ad:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 7b4:	0a 00 00 
    base.s.size = 0;
 7b7:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 7be:	00 00 00 
