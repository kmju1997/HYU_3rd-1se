...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      ...
      18:	e8 13 3e 00 00       	call   3e30 <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      ...
      44:	e8 e7 3d 00 00       	call   3e30 <printf>
    exit();
...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
     ...
     146:	e8 e5 3c 00 00       	call   3e30 <printf>
  ...
  printf(stdout, "iput test ok\n");
     ...
     19f:	e8 8c 3c 00 00       	call   3e30 <printf>
}
     1a4:	c9                   	leave  
     1a5:	c3                   	ret    
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    printf(stdout, "mkdir failed\n");
     ...
     1b6:	e8 75 3c 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("/") < 0){
    printf(stdout, "chdir / failed\n");
     ...
     1d0:	e8 5b 3c 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("../iputdir") < 0){
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1ea:	e8 41 3c 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("iputdir") < 0){
    printf(stdout, "chdir iputdir failed\n");
     ...
     204:	e8 27 3c 00 00       	call   3e30 <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     226:	e8 05 3c 00 00       	call   3e30 <printf>
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	e8 a6 3b 00 00       	call   3e30 <printf>
}
     28a:	c9                   	leave  
     28b:	c3                   	ret    
    ...
    if(unlink("../iputdir") < 0){
     ...
     2a0:	e8 8b 3b 00 00       	call   3e30 <printf>
      exit();
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     ...
     2ba:	e8 71 3b 00 00       	call   3e30 <printf>
    exit();
    ...
    if(chdir("iputdir") < 0){
     ...
     2d4:	e8 57 3b 00 00       	call   3e30 <printf>
      exit();
  ...
  if(pid == 0){
    if(mkdir("iputdir") < 0){
     ...
     2ee:	e8 3d 3b 00 00       	call   3e30 <printf>
      exit();
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     316:	e8 15 3b 00 00       	call   3e30 <printf>
  if(mkdir("oidir") < 0){
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     36a:	e8 c1 3a 00 00       	call   3e30 <printf>
      exit();
  ...
  sleep(1);
     ...
     37f:	e8 b6 39 00 00       	call   3d3a <sleep>
  if(unlink("oidir") != 0){
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3a9:	e8 82 3a 00 00       	call   3e30 <printf>
}
     3ae:	c9                   	leave  
     3af:	c3                   	ret    
    }
  ...
  if(unlink("oidir") != 0){
    printf(stdout, "unlink failed\n");
     ...
     3c0:	e8 6b 3a 00 00       	call   3e30 <printf>
     ...
     3c8:	e8 d5 38 00 00       	call   3ca2 <exit>
{
  ...
  if(mkdir("oidir") < 0){
    printf(stdout, "mkdir oidir failed\n");
     ...
     3dd:	e8 4e 3a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(pid < 0){
    printf(stdout, "fork failed\n");
     ...
     3f7:	e8 34 3a 00 00       	call   3e30 <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     426:	e8 05 3a 00 00       	call   3e30 <printf>
  fd = open("echo", 0);
  ...
  printf(stdout, "open test ok\n");
     ...
     473:	e8 b8 39 00 00       	call   3e30 <printf>
}
     478:	c9                   	leave  
     479:	c3                   	ret    
  int fd;
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
     ...
     48a:	e8 a1 39 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     4a4:	e8 87 39 00 00       	call   3e30 <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     4c8:	e8 63 39 00 00       	call   3e30 <printf>
     ...
     4e1:	85 c0                	test   %eax,%eax
{
  ...
  if(fd >= 0){
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4fd:	e8 2e 39 00 00       	call   3e30 <printf>
  ...
  printf(stdout, "writes ok\n");
     ...
     562:	e8 c9 38 00 00       	call   3e30 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     59d:	e8 8e 38 00 00       	call   3e30 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5d5:	e8 56 38 00 00       	call   3e30 <printf>
  } else {
  ...
  printf(stdout, "small file test ok\n");
     ...
     606:	e8 25 38 00 00       	call   3e30 <printf>
}
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     626:	e8 05 38 00 00       	call   3e30 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     644:	e8 e7 37 00 00       	call   3e30 <printf>
      exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     65e:	e8 cd 37 00 00       	call   3e30 <printf>
    exit();
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     678:	e8 b3 37 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     692:	e8 99 37 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     6ac:	e8 7f 37 00 00       	call   3e30 <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     6d8:	e8 53 37 00 00       	call   3e30 <printf>
     ...
     6f1:	85 c0                	test   %eax,%eax
{
  ...
  printf(stdout, "big files ok\n");
     ...
     7cf:	e8 5c 36 00 00       	call   3e30 <printf>
}
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     7ef:	e8 3c 36 00 00       	call   3e30 <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     811:	e8 1a 36 00 00       	call   3e30 <printf>
             n, ((int*)buf)[0]);
      exit();
     ...
     82f:	e8 fc 35 00 00       	call   3e30 <printf>
      exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     851:	e8 da 35 00 00       	call   3e30 <printf>
        exit();
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
     ...
     86b:	e8 c0 35 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
     ...
     885:	e8 a6 35 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     89f:	e8 8c 35 00 00       	call   3e30 <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     8cc:	e8 5f 35 00 00       	call   3e30 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     94a:	e8 e1 34 00 00       	call   3e30 <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     976:	e8 b5 34 00 00       	call   3e30 <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     9cf:	e8 5c 34 00 00       	call   3e30 <printf>
}
     9d4:	c9                   	leave  
     9d5:	c3                   	ret    
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
     ...
     9e6:	e8 45 34 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
     ...
     a00:	e8 2b 34 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
     ...
     a1a:	e8 11 34 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
     ...
     a34:	e8 f7 33 00 00       	call   3e30 <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     a56:	e8 d5 33 00 00       	call   3e30 <printf>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     ...
     a85:	e8 a6 33 00 00       	call   3e30 <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     b40:	e8 eb 32 00 00       	call   3e30 <printf>
  } else {
...
pipe1(void)
{
  ...
  printf(1, "pipe1 ok\n");
     ...
     bd3:	e8 58 32 00 00       	call   3e30 <printf>
    ...
    if(total != 5 * 1033){
     ...
     bf3:	e8 38 32 00 00       	call   3e30 <printf>
     bf8:	eb ac                	jmp    ba6 <pipe1+0x116>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     ...
     c09:	e8 22 32 00 00       	call   3e30 <printf>
    exit();
    ...
    printf(1, "fork() failed\n");
     ...
     c22:	e8 09 32 00 00       	call   3e30 <printf>
    exit();
    ...
    for(n = 0; n < 5; n++){
     ...
     c3b:	e8 f0 31 00 00       	call   3e30 <printf>
        exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     c68:	e8 c3 31 00 00       	call   3e30 <printf>
  pid1 = fork();
     ...
     c72:	85 c0                	test   %eax,%eax
{
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     cdd:	e8 4e 31 00 00       	call   3e30 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     d29:	e8 02 31 00 00       	call   3e30 <printf>
  printf(1, "wait... ");
  wait();
  wait();
  wait();
  ...
  printf(1, "kill... ");
     ...
     d50:	e8 db 30 00 00       	call   3e30 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     d7c:	e8 af 30 00 00       	call   3e30 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     da4:	e8 87 30 00 00       	call   3e30 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     dec:	e8 3f 30 00 00       	call   3e30 <printf>
    } else {
      exit();
    }
  }
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     e07:	e8 24 30 00 00       	call   3e30 <printf>
    } else {
      exit();
    }
  }
  ...
  printf(1, "exitwait ok\n");
     ...
     e27:	e8 04 30 00 00       	call   3e30 <printf>
}
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     e58:	e8 d3 2f 00 00       	call   3e30 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     ...
     ecf:	e8 5c 2f 00 00       	call   3e30 <printf>
    exit();
    ...
    if(m1 == 0){
     ...
     eff:	e8 2c 2f 00 00       	call   3e30 <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     f38:	e8 f3 2e 00 00       	call   3e30 <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     fc5:	e8 66 2e 00 00       	call   3e30 <printf>
      break;
    }
  }
  if(pid == 0)
  ...
  if(nc == 10000 && np == 10000){
    ...
    109a:	e8 91 2d 00 00       	call   3e30 <printf>
  } else {
  ...
  if(fd < 0){
    ...
    10b6:	e8 75 2d 00 00       	call   3e30 <printf>
    printf(1, "sharedfd ok\n");
  } else {
    printf(1, "sharedfd oops %d %d\n", nc, np);
    exit();
  ...
  if(fd < 0){
    ...
    10d2:	e8 59 2d 00 00       	call   3e30 <printf>
    printf(1, "sharedfd ok\n");
  } else {
    printf(1, "sharedfd oops %d %d\n", nc, np);
    exit();
  ...
  if(nc == 10000 && np == 10000){
    ...
    10f6:	e8 35 2d 00 00       	call   3e30 <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    113b:	e8 f0 2c 00 00       	call   3e30 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    1209:	e8 22 2c 00 00       	call   3e30 <printf>
}
    ...
    1235:	e8 f6 2b 00 00       	call   3e30 <printf>
          exit();
    ...
    12b7:	e8 74 2b 00 00       	call   3e30 <printf>
          exit();
    ...
    12d4:	e8 57 2b 00 00       	call   3e30 <printf>
      exit();
    ...
    12ed:	e8 3e 2b 00 00       	call   3e30 <printf>
      exit();
    ...
    1306:	e8 25 2b 00 00       	call   3e30 <printf>
        exit();
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    132a:	e8 01 2b 00 00       	call   3e30 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    1424:	e8 07 2a 00 00       	call   3e30 <printf>
}
  ...
  for(i = 0; i < N; i++){
    ...
    14cb:	e8 60 29 00 00       	call   3e30 <printf>
            exit();
    ...
    14eb:	e8 40 29 00 00       	call   3e30 <printf>
        exit();
    ...
    1504:	e8 27 29 00 00       	call   3e30 <printf>
          exit();
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    151d:	e8 0e 29 00 00       	call   3e30 <printf>
      exit();
    ...
    153a:	e8 f1 28 00 00       	call   3e30 <printf>
        exit();
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1567:	e8 c4 28 00 00       	call   3e30 <printf>
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread ok\n");
    ...
    167c:	e8 af 27 00 00       	call   3e30 <printf>
}
  ...
  if(fd < 0){
    ...
    1697:	e8 94 27 00 00       	call   3e30 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    16b0:	e8 7b 27 00 00       	call   3e30 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    16c9:	e8 62 27 00 00       	call   3e30 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16e2:	e8 49 27 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("unlinkread") != 0){
    ...
    16fb:	e8 30 27 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1714:	e8 17 27 00 00       	call   3e30 <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    1736:	e8 f5 26 00 00       	call   3e30 <printf>
  ...
  printf(1, "linktest ok\n");
    ...
    188c:	e8 9f 25 00 00       	call   3e30 <printf>
}
  ...
  if(fd < 0){
    ...
    18a6:	e8 85 25 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    ...
    18bf:	e8 6c 25 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    18d8:	e8 53 25 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    18f1:	e8 3a 25 00 00       	call   3e30 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    190a:	e8 21 25 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1923:	e8 08 25 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    ...
    193c:	e8 ef 24 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1955:	e8 d6 24 00 00       	call   3e30 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    196e:	e8 bd 24 00 00       	call   3e30 <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    199d:	e8 8e 24 00 00       	call   3e30 <printf>
  file[0] = 'C';
  ...
  printf(1, "concreate ok\n");
    ...
    1bff:	e8 2c 22 00 00       	call   3e30 <printf>
}
  ...
  for(i = 0; i < 40; i++){
    ...
    1c1b:	e8 10 22 00 00       	call   3e30 <printf>
      exit();
    ...
    1c38:	e8 f3 21 00 00       	call   3e30 <printf>
        exit();
    ...
    1c58:	e8 d3 21 00 00       	call   3e30 <printf>
  ...
  if(n != 40){
    ...
    1c71:	e8 ba 21 00 00       	call   3e30 <printf>
    exit();
    ...
    1c91:	e8 9a 21 00 00       	call   3e30 <printf>
        exit();
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1cb8:	e8 73 21 00 00       	call   3e30 <printf>
  ...
  printf(1, "linkunlink ok\n");
    ...
    1d65:	e8 c6 20 00 00       	call   3e30 <printf>
}
  ...
  if(pid < 0){
    ...
    1da0:	e8 8b 20 00 00       	call   3e30 <printf>
    exit();
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    1dc7:	e8 64 20 00 00       	call   3e30 <printf>
  unlink("bd");
  ...
  printf(1, "bigdir ok\n");
    ...
    1e9c:	e8 8f 1f 00 00       	call   3e30 <printf>
}
    ...
    1eb7:	e8 74 1f 00 00       	call   3e30 <printf>
      exit();
    ...
    1ed0:	e8 5b 1f 00 00       	call   3e30 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    1ee9:	e8 42 1f 00 00       	call   3e30 <printf>
    exit();
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1f16:	e8 15 1f 00 00       	call   3e30 <printf>
  ...
  printf(1, "subdir ok\n");
    ...
    2311:	e8 1a 1b 00 00       	call   3e30 <printf>
}
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    232b:	e8 00 1b 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2344:	e8 e7 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    235d:	e8 ce 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2376:	e8 b5 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    238f:	e8 9c 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    23a8:	e8 83 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    23c1:	e8 6a 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    23da:	e8 51 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    23f3:	e8 38 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    ...
    240c:	e8 1f 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2425:	e8 06 1a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    243e:	e8 ed 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2457:	e8 d4 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2470:	e8 bb 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2489:	e8 a2 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    24a2:	e8 89 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    24bb:	e8 70 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    ...
    24d4:	e8 57 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    24ed:	e8 3e 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2506:	e8 25 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    ...
    251f:	e8 0c 19 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2538:	e8 f3 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("dd") != 0){
    ...
    2551:	e8 da 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    ...
    256a:	e8 c1 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    ...
    2583:	e8 a8 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    ...
    259c:	e8 8f 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    ...
    25b5:	e8 76 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    ...
    25ce:	e8 5d 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    ...
    25e7:	e8 44 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2600:	e8 2b 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2619:	e8 12 18 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2632:	e8 f9 17 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    264b:	e8 e0 17 00 00       	call   3e30 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2664:	e8 c7 17 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    267d:	e8 ae 17 00 00       	call   3e30 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    26ac:	e8 7f 17 00 00       	call   3e30 <printf>
  ...
  printf(1, "bigwrite ok\n");
    ...
    273f:	e8 ec 16 00 00       	call   3e30 <printf>
}
    ...
    2762:	e8 c9 16 00 00       	call   3e30 <printf>
        exit();
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    277b:	e8 b0 16 00 00       	call   3e30 <printf>
      exit();
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    27a8:	e8 83 16 00 00       	call   3e30 <printf>
  ...
  printf(1, "bigfile test ok\n");
    ...
    28cc:	e8 5f 15 00 00       	call   3e30 <printf>
}
    ...
    28e8:	e8 43 15 00 00       	call   3e30 <printf>
      exit();
    ...
    2901:	e8 2a 15 00 00       	call   3e30 <printf>
      exit();
  ...
  for(i = 0; ; i++){
    ...
    291a:	e8 11 15 00 00       	call   3e30 <printf>
      exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2933:	e8 f8 14 00 00       	call   3e30 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    294c:	e8 df 14 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2965:	e8 c6 14 00 00       	call   3e30 <printf>
    exit();
  ...
  if(total != 20*600){
    ...
    297e:	e8 ad 14 00 00       	call   3e30 <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    29a5:	e8 86 14 00 00       	call   3e30 <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    2a49:	e8 e2 13 00 00       	call   3e30 <printf>
}
    2a4e:	c9                   	leave  
    2a4f:	c3                   	ret    
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2a5f:	e8 cc 13 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2a78:	e8 b3 13 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2a91:	e8 9a 13 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2aaa:	e8 81 13 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2ac3:	e8 68 13 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2adc:	e8 4f 13 00 00       	call   3e30 <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    2b05:	e8 26 13 00 00       	call   3e30 <printf>
  if(mkdir("dots") != 0){
  ...
  printf(1, "rmdot ok\n");
    ...
    2bb1:	e8 7a 12 00 00       	call   3e30 <printf>
}
    2bb6:	c9                   	leave  
    2bb7:	c3                   	ret    
void
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2bc7:	e8 64 12 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dots") != 0){
    ...
    2be0:	e8 4b 12 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dots/..") == 0){
    ...
    2bf9:	e8 32 12 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dots/.") == 0){
    ...
    2c12:	e8 19 12 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("/") != 0){
    ...
    2c2b:	e8 00 12 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("..") == 0){
    ...
    2c44:	e8 e7 11 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink(".") == 0){
    ...
    2c5d:	e8 ce 11 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("dots") != 0){
    ...
    2c76:	e8 b5 11 00 00       	call   3e30 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2c96:	e8 95 11 00 00       	call   3e30 <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    2dc8:	e8 63 10 00 00       	call   3e30 <printf>
}
  ...
  if(fd >= 0){
    ...
    2de2:	e8 49 10 00 00       	call   3e30 <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    ...
    2dfb:	e8 30 10 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2e14:	e8 17 10 00 00       	call   3e30 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2e2d:	e8 fe 0f 00 00       	call   3e30 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2e46:	e8 e5 0f 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dirfile") != 0){
    ...
    2e5f:	e8 cc 0f 00 00       	call   3e30 <printf>
    exit();
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2e78:	e8 b3 0f 00 00       	call   3e30 <printf>
    exit();
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2e91:	e8 9a 0f 00 00       	call   3e30 <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2eaa:	e8 81 0f 00 00       	call   3e30 <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2edb:	e8 50 0f 00 00       	call   3e30 <printf>
  ...
  printf(1, "empty file name OK\n");
    ...
    2f98:	e8 93 0e 00 00       	call   3e30 <printf>
}
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb2:	e8 79 0e 00 00       	call   3e30 <printf>
      exit();
    ...
    2fcb:	e8 60 0e 00 00       	call   3e30 <printf>
      exit();
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    2ff8:	e8 33 0e 00 00       	call   3e30 <printf>
    ...
    3000:	0f 84 87 00 00 00    	je     308d <forktest+0xad>
{
  ...
  printf(1, "fork test OK\n");
    ...
    3051:	e8 da 0d 00 00       	call   3e30 <printf>
}
  ...
  if(n == 1000){
    ...
    306f:	e8 bc 0d 00 00       	call   3e30 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3088:	e8 a3 0d 00 00       	call   3e30 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30a1:	e8 8a 0d 00 00       	call   3e30 <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    30cb:	e8 60 0d 00 00       	call   3e30 <printf>
  oldbrk = sbrk(0);
    30d0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    30d7:	e8 56 0c 00 00       	call   3d32 <sbrk>
  ...
  // can one sbrk() less than a page?
  a = sbrk(0);
    30e6:	e8 47 0c 00 00       	call   3d32 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    30f7:	e8 36 0c 00 00       	call   3d32 <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    ...
    312e:	e8 ff 0b 00 00       	call   3d32 <sbrk>
  c = sbrk(1);
    3133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    313a:	e8 f3 0b 00 00       	call   3d32 <sbrk>
  if(c != a + 1){
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    315e:	e8 cf 0b 00 00       	call   3d32 <sbrk>
  amt = (BIG) - (uint)a;
...
#define BIG (100*1024*1024)
  ...
  p = sbrk(amt);
    ...
    316f:	e8 be 0b 00 00       	call   3d32 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    318a:	e8 a3 0b 00 00       	call   3d32 <sbrk>
  c = sbrk(-4096);
  ...
  *lastaddr = 99;
  ...
  c = sbrk(-4096);
    3198:	e8 95 0b 00 00       	call   3d32 <sbrk>
  ...
  c = sbrk(0);
    ...
    31ad:	e8 80 0b 00 00       	call   3d32 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    31c7:	e8 66 0b 00 00       	call   3d32 <sbrk>
  c = sbrk(4096);
  ...
  c = sbrk(4096);
    31d5:	e8 58 0b 00 00       	call   3d32 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    31eb:	e8 42 0b 00 00       	call   3d32 <sbrk>
  ...
  a = sbrk(0);
    ...
    3212:	e8 1b 0b 00 00       	call   3d32 <sbrk>
  ...
  c = sbrk(4096);
    ...
    32c5:	e8 68 0a 00 00       	call   3d32 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    332a:	e8 01 0b 00 00       	call   3e30 <printf>
}
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3377:	e8 be 09 00 00       	call   3d3a <sleep>
  ...
  for(i = 0; i < 5000; i++){
    ...
    339a:	e8 91 0a 00 00       	call   3e30 <printf>
      exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    33b4:	e8 77 0a 00 00       	call   3e30 <printf>
    exit();
  ...
  if(pipe(fds) != 0){
    ...
    33cd:	e8 5e 0a 00 00       	call   3e30 <printf>
    exit();
    ...
    33f2:	e8 39 0a 00 00       	call   3e30 <printf>
      kill(ppid);
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3414:	e8 17 0a 00 00       	call   3e30 <printf>
      exit();
  ...
  if(c != a){
    ...
    3436:	e8 f5 09 00 00       	call   3e30 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3450:	e8 db 09 00 00       	call   3e30 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3472:	e8 b9 09 00 00       	call   3e30 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    3494:	e8 97 09 00 00       	call   3e30 <printf>
    exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    34ae:	e8 7d 09 00 00       	call   3e30 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    34c8:	e8 63 09 00 00       	call   3e30 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    34e2:	e8 49 09 00 00       	call   3e30 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    34fc:	e8 2f 09 00 00       	call   3e30 <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    353a:	e8 f1 08 00 00       	call   3e30 <printf>
    353f:	90                   	nop
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3552:	e8 e3 07 00 00       	call   3d3a <sleep>
    sleep(0);
    3557:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    355e:	e8 d7 07 00 00       	call   3d3a <sleep>
    kill(pid);
  ...
  printf(stdout, "validate ok\n");
    ...
    35a3:	e8 88 08 00 00       	call   3e30 <printf>
}
    ...
    35bf:	e8 6c 08 00 00       	call   3e30 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    35e6:	e8 45 08 00 00       	call   3e30 <printf>
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    3623:	e8 08 08 00 00       	call   3e30 <printf>
}
    3628:	c9                   	leave  
    3629:	c3                   	ret    
  int i;
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    363a:	e8 f1 07 00 00       	call   3e30 <printf>
      exit();
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    36dd:	e8 4e 07 00 00       	call   3e30 <printf>
    exec("echo", args);
    ...
    3706:	e8 25 07 00 00       	call   3e30 <printf>
    fd = open("bigarg-ok", O_CREATE);
  ...
  if(fd < 0){
    ...
    373c:	e8 ef 06 00 00       	call   3e30 <printf>
    exit();
    ...
    3756:	e8 d5 06 00 00       	call   3e30 <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    377a:	e8 b1 06 00 00       	call   3e30 <printf>
    377f:	90                   	nop
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3818:	e8 13 06 00 00       	call   3e30 <printf>
    ...
    3874:	e8 b7 05 00 00       	call   3e30 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    38a3:	e8 88 05 00 00       	call   3e30 <printf>
  }
  ...
  printf(1, "fsfull test finished\n");
    ...
    3950:	e8 db 04 00 00       	call   3e30 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    ...
    3975:	e8 b6 04 00 00       	call   3e30 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    3999:	e8 92 04 00 00       	call   3e30 <printf>
}
    399e:	c9                   	leave  
    399f:	c3                   	ret    
  pid = fork();
  if(pid == 0){
    ...
    39bd:	e8 6e 04 00 00       	call   3e30 <printf>
    exit();
    ...
    39d6:	e8 55 04 00 00       	call   3e30 <printf>
    exit();
...
void argptest()
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    3a08:	e8 25 03 00 00       	call   3d32 <sbrk>
  ...
  printf(1, "arg test passed\n");
    ...
    3a3b:	e8 f0 03 00 00       	call   3e30 <printf>
}
...
void argptest()
{
  ...
  if (fd < 0) {
    ...
    3a55:	e8 d6 03 00 00       	call   3e30 <printf>
    exit();
...
00003cc2 <write>:
SYSCALL(write)
    3cc2:	b8 11 00 00 00       	mov    $0x11,%eax
    3cc7:	cd 40                	int    $0x40
    3cc9:	c3                   	ret    

00003cca <close>:
SYSCALL(close)
    3cca:	b8 16 00 00 00       	mov    $0x16,%eax
    3ccf:	cd 40                	int    $0x40
    3cd1:	c3                   	ret    
...
00003ce2 <open>:
SYSCALL(open)
    3ce2:	b8 10 00 00 00       	mov    $0x10,%eax
    3ce7:	cd 40                	int    $0x40
    3ce9:	c3                   	ret    

00003cea <mknod>:
SYSCALL(mknod)
    3cea:	b8 12 00 00 00       	mov    $0x12,%eax
    3cef:	cd 40                	int    $0x40
    3cf1:	c3                   	ret    

00003cf2 <unlink>:
SYSCALL(unlink)
    3cf2:	b8 13 00 00 00       	mov    $0x13,%eax
    3cf7:	cd 40                	int    $0x40
    3cf9:	c3                   	ret    
...
00003d02 <link>:
SYSCALL(link)
    3d02:	b8 14 00 00 00       	mov    $0x14,%eax
    3d07:	cd 40                	int    $0x40
    3d09:	c3                   	ret    

00003d0a <mkdir>:
SYSCALL(mkdir)
    3d0a:	b8 15 00 00 00       	mov    $0x15,%eax
    3d0f:	cd 40                	int    $0x40
    3d11:	c3                   	ret    
...
00003d42 <uptime>:
SYSCALL(uptime)
    3d42:	b8 0f 00 00 00       	mov    $0xf,%eax
    3d47:	cd 40                	int    $0x40
    3d49:	c3                   	ret    
...
00003d62 <set_cpu_share>:
SYSCALL(set_cpu_share)
    3d62:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3d67:	cd 40                	int    $0x40
    3d69:	c3                   	ret    

00003d6a <thread_create>:
SYSCALL(thread_create)
    3d6a:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3d6f:	cd 40                	int    $0x40
    3d71:	c3                   	ret    

00003d72 <thread_exit>:
SYSCALL(thread_exit)
    3d72:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3d77:	cd 40                	int    $0x40
    3d79:	c3                   	ret    

00003d7a <thread_join>:
SYSCALL(thread_join)
    3d7a:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3d7f:	cd 40                	int    $0x40
    3d81:	c3                   	ret    
    3d82:	66 90                	xchg   %ax,%ax
    3d84:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3d93:	57                   	push   %edi
    3d94:	56                   	push   %esi
    3d95:	89 c6                	mov    %eax,%esi
    3d97:	53                   	push   %ebx
    3d98:	83 ec 4c             	sub    $0x4c,%esp
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3d9b:	8b 5d 08             	mov    0x8(%ebp),%ebx
    3d9e:	85 db                	test   %ebx,%ebx
    3da0:	74 09                	je     3dab <printint+0x1b>
    3da2:	89 d0                	mov    %edx,%eax
    3da4:	c1 e8 1f             	shr    $0x1f,%eax
    3da7:	84 c0                	test   %al,%al
    3da9:	75 75                	jne    3e20 <printint+0x90>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    3dab:	89 d0                	mov    %edx,%eax
  ...
  neg = 0;
    3dad:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    3db4:	89 75 c0             	mov    %esi,-0x40(%ebp)
    x = -xx;
  } else {
    x = xx;
  }
  ...
  i = 0;
    3db7:	31 ff                	xor    %edi,%edi
    3db9:	89 ce                	mov    %ecx,%esi
    3dbb:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    3dbe:	eb 02                	jmp    3dc2 <printint+0x32>
  do{
    buf[i++] = digits[x % base];
    3dc0:	89 cf                	mov    %ecx,%edi
    3dc2:	31 d2                	xor    %edx,%edx
    3dc4:	f7 f6                	div    %esi
    3dc6:	8d 4f 01             	lea    0x1(%edi),%ecx
    3dc9:	0f b6 92 37 59 00 00 	movzbl 0x5937(%edx),%edx
  }while((x /= base) != 0);
  ...
  do{
    buf[i++] = digits[x % base];
    3dd2:	88 14 0b             	mov    %dl,(%ebx,%ecx,1)
  }while((x /= base) != 0);
    3dd5:	75 e9                	jne    3dc0 <printint+0x30>
  if(neg)
    3dd7:	8b 55 c4             	mov    -0x3c(%ebp),%edx
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
    3dda:	89 c8                	mov    %ecx,%eax
    3ddc:	8b 75 c0             	mov    -0x40(%ebp),%esi
  }while((x /= base) != 0);
  if(neg)
    3ddf:	85 d2                	test   %edx,%edx
    3de1:	74 08                	je     3deb <printint+0x5b>
    buf[i++] = '-';
    3de3:	8d 4f 02             	lea    0x2(%edi),%ecx
    3de6:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)

  while(--i >= 0)
    3deb:	8d 79 ff             	lea    -0x1(%ecx),%edi
    3dee:	66 90                	xchg   %ax,%ax
    3df0:	0f b6 44 3d d8       	movzbl -0x28(%ebp,%edi,1),%eax
    3df5:	83 ef 01             	sub    $0x1,%edi
#include "user.h"
...
{
  write(fd, &c, 1);
    3df8:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3dff:	00 
    3e00:	89 5c 24 04          	mov    %ebx,0x4(%esp)
    3e04:	89 34 24             	mov    %esi,(%esp)
    3e07:	88 45 d7             	mov    %al,-0x29(%ebp)
    3e0a:	e8 b3 fe ff ff       	call   3cc2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3e0f:	83 ff ff             	cmp    $0xffffffff,%edi
    3e12:	75 dc                	jne    3df0 <printint+0x60>
    putc(fd, buf[i]);
}
    3e14:	83 c4 4c             	add    $0x4c,%esp
    3e17:	5b                   	pop    %ebx
    3e18:	5e                   	pop    %esi
    3e19:	5f                   	pop    %edi
    3e1a:	5d                   	pop    %ebp
    3e1b:	c3                   	ret    
    3e1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    3e24:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
    3e2b:	eb 87                	jmp    3db4 <printint+0x24>
...
printf(int fd, char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3e3e:	8d 45 10             	lea    0x10(%ebp),%eax
}
...
printf(int fd, char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3e44:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  for(i = 0; fmt[i]; i++){
    3e47:	0f b6 13             	movzbl (%ebx),%edx
    3e4a:	83 c3 01             	add    $0x1,%ebx
    3e4d:	84 d2                	test   %dl,%dl
    3e4f:	75 39                	jne    3e8a <printf+0x5a>
    3e51:	e9 c2 00 00 00       	jmp    3f18 <printf+0xe8>
    3e56:	66 90                	xchg   %ax,%ax
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    3e58:	83 fa 25             	cmp    $0x25,%edx
    3e5b:	0f 84 bf 00 00 00    	je     3f20 <printf+0xf0>
#include "user.h"
...
{
  write(fd, &c, 1);
    3e61:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    3e64:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3e6b:	00 
    3e6c:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e70:	89 34 24             	mov    %esi,(%esp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
...
{
  write(fd, &c, 1);
    3e76:	e8 47 fe ff ff       	call   3cc2 <write>
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3e7e:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3e82:	84 d2                	test   %dl,%dl
    3e84:	0f 84 8e 00 00 00    	je     3f18 <printf+0xe8>
    c = fmt[i] & 0xff;
    if(state == 0){
    3e8a:	85 ff                	test   %edi,%edi
  uint *ap;
  ...
  for(i = 0; fmt[i]; i++){
    c = fmt[i] & 0xff;
    3e8c:	0f be c2             	movsbl %dl,%eax
    if(state == 0){
    3e8f:	74 c7                	je     3e58 <printf+0x28>
      if(c == '%'){
        state = '%';
      } else {
        putc(fd, c);
    ...
    3e91:	83 ff 25             	cmp    $0x25,%edi
    3e94:	75 e5                	jne    3e7b <printf+0x4b>
      if(c == 'd'){
    3e96:	83 fa 64             	cmp    $0x64,%edx
    3e99:	0f 84 31 01 00 00    	je     3fd0 <printf+0x1a0>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3e9f:	25 f7 00 00 00       	and    $0xf7,%eax
    3ea4:	83 f8 70             	cmp    $0x70,%eax
    3ea7:	0f 84 83 00 00 00    	je     3f30 <printf+0x100>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3ead:	83 fa 73             	cmp    $0x73,%edx
    3eb0:	0f 84 a2 00 00 00    	je     3f58 <printf+0x128>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3eb6:	83 fa 63             	cmp    $0x63,%edx
    3eb9:	0f 84 35 01 00 00    	je     3ff4 <printf+0x1c4>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3ebf:	83 fa 25             	cmp    $0x25,%edx
    3ec2:	0f 84 e0 00 00 00    	je     3fa8 <printf+0x178>
#include "user.h"
...
{
  write(fd, &c, 1);
    3ec8:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    3ecb:	83 c3 01             	add    $0x1,%ebx
    3ece:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ed5:	00 
      } else {
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3edc:	89 34 24             	mov    %esi,(%esp)
    3edf:	89 55 d0             	mov    %edx,-0x30(%ebp)
    3ee2:	c6 45 e6 25          	movb   $0x25,-0x1a(%ebp)
    3ee6:	e8 d7 fd ff ff       	call   3cc2 <write>
      } else if(c == '%'){
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    3eeb:	8b 55 d0             	mov    -0x30(%ebp),%edx
#include "user.h"
...
{
  write(fd, &c, 1);
    3eee:	8d 45 e7             	lea    -0x19(%ebp),%eax
    3ef1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3ef8:	00 
    3ef9:	89 44 24 04          	mov    %eax,0x4(%esp)
    3efd:	89 34 24             	mov    %esi,(%esp)
      } else if(c == '%'){
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
...
{
  write(fd, &c, 1);
    3f03:	e8 ba fd ff ff       	call   3cc2 <write>
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f08:	0f b6 53 ff          	movzbl -0x1(%ebx),%edx
    3f0c:	84 d2                	test   %dl,%dl
    3f0e:	0f 85 76 ff ff ff    	jne    3e8a <printf+0x5a>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
      if(c == '%'){
        state = '%';
    3f20:	bf 25 00 00 00       	mov    $0x25,%edi
    3f25:	e9 51 ff ff ff       	jmp    3e7b <printf+0x4b>
    ...
    3f43:	89 f0                	mov    %esi,%eax
    3f45:	e8 46 fe ff ff       	call   3d90 <printint>
        ap++;
    3f4a:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3f4e:	e9 28 ff ff ff       	jmp    3e7b <printf+0x4b>
    3f53:	90                   	nop
    3f54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      } else if(c == 's'){
        s = (char*)*ap;
    3f58:	8b 45 d4             	mov    -0x2c(%ebp),%eax
        ap++;
    3f5b:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
        ...
        s = (char*)*ap;
    3f5f:	8b 38                	mov    (%eax),%edi
        ap++;
        if(s == 0)
          s = "(null)";
    3f61:	b8 30 59 00 00       	mov    $0x5930,%eax
    3f66:	85 ff                	test   %edi,%edi
    3f68:	0f 44 f8             	cmove  %eax,%edi
        while(*s != 0){
    3f6b:	0f b6 07             	movzbl (%edi),%eax
    3f6e:	84 c0                	test   %al,%al
    3f70:	74 2a                	je     3f9c <printf+0x16c>
    3f72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    3f78:	88 45 e3             	mov    %al,-0x1d(%ebp)
#include "user.h"
...
{
  write(fd, &c, 1);
    3f7b:	8d 45 e3             	lea    -0x1d(%ebp),%eax
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3f90:	e8 2d fd ff ff       	call   3cc2 <write>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    3f95:	0f b6 07             	movzbl (%edi),%eax
    3f98:	84 c0                	test   %al,%al
    3f9a:	75 dc                	jne    3f78 <printf+0x148>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
      ...
      state = 0;
    3f9c:	31 ff                	xor    %edi,%edi
    3f9e:	e9 d8 fe ff ff       	jmp    3e7b <printf+0x4b>
    3fa3:	90                   	nop
...
{
  write(fd, &c, 1);
    3fa8:	8d 45 e5             	lea    -0x1b(%ebp),%eax
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
...
{
  write(fd, &c, 1);
    3fad:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3fb4:	00 
    3fb5:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fb9:	89 34 24             	mov    %esi,(%esp)
    3fbc:	c6 45 e5 25          	movb   $0x25,-0x1b(%ebp)
    3fc0:	e8 fd fc ff ff       	call   3cc2 <write>
    3fc5:	e9 b1 fe ff ff       	jmp    3e7b <printf+0x4b>
    ...
    3fd3:	b9 0a 00 00 00       	mov    $0xa,%ecx
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    ...
    3fd8:	66 31 ff             	xor    %di,%di
      ...
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
    3fdb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3fe2:	8b 10                	mov    (%eax),%edx
    3fe4:	89 f0                	mov    %esi,%eax
    3fe6:	e8 a5 fd ff ff       	call   3d90 <printint>
        ap++;
    3feb:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    3fef:	e9 87 fe ff ff       	jmp    3e7b <printf+0x4b>
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
        ...
        putc(fd, *ap);
    3ff4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
...
{
  write(fd, &c, 1);
    3ffb:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    4002:	00 
    4003:	89 34 24             	mov    %esi,(%esp)
        while(*s != 0){
          putc(fd, *s);
          s++;
        }
...
{
  write(fd, &c, 1);
    4009:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    400c:	89 44 24 04          	mov    %eax,0x4(%esp)
    4010:	e8 ad fc ff ff       	call   3cc2 <write>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
        putc(fd, *ap);
        ap++;
    4015:	83 45 d4 04          	addl   $0x4,-0x2c(%ebp)
    4019:	e9 5d fe ff ff       	jmp    3e7b <printf+0x4b>
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    411a:	e8 13 fc ff ff       	call   3d32 <sbrk>
  if(p == (char*)-1)
