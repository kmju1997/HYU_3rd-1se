...
main(int argc, char *argv[])
{
   ...
   9:	c7 04 24 a6 07 00 00 	movl   $0x7a6,(%esp)
  10:	e8 45 03 00 00       	call   35a <my_syscall>
    printf(1, "Return value : 0x%x\n", ret_val);
  15:	c7 44 24 04 b1 07 00 	movl   $0x7b1,0x4(%esp)
  1c:	00 
  1d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  24:	89 44 24 08          	mov    %eax,0x8(%esp)
  28:	e8 13 04 00 00       	call   440 <printf>
    printf(1, "My pid : %x\n", getpid());
  2d:	e8 00 03 00 00       	call   332 <getpid>
  32:	c7 44 24 04 c6 07 00 	movl   $0x7c6,0x4(%esp)
  39:	00 
  3a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  41:	89 44 24 08          	mov    %eax,0x8(%esp)
  45:	e8 f6 03 00 00       	call   440 <printf>
    printf(1, "My ppid : %x\n", getppid());
  4a:	e8 eb 02 00 00       	call   33a <getppid>
  4f:	c7 44 24 04 d3 07 00 	movl   $0x7d3,0x4(%esp)
  56:	00 
  ...
  67:	c7 44 24 04 e1 07 00 	movl   $0x7e1,0x4(%esp)
  6e:	00 
  ...
  7b:	cd 80                	int    $0x80
    exit();
  7d:	e8 30 02 00 00       	call   2b2 <exit>
  82:	66 90                	xchg   %ax,%ax
  84:	66 90                	xchg   %ax,%ax
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d9:	0f b6 92 f8 07 00 00 	movzbl 0x7f8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 56f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 571:	b8 f1 07 00 00       	mov    $0x7f1,%eax
...
free(void *ap)
{
 ...
 631:	a1 70 0a 00 00       	mov    0xa70,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 677:	89 10                	mov    %edx,(%eax)
  freep = p;
 679:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 ...
 69f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 6a2:	a3 70 0a 00 00       	mov    %eax,0xa70
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 1d 70 0a 00 00    	mov    0xa70,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 709:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 70b:	3b 15 70 0a 00 00    	cmp    0xa70,%edx
...
morecore(uint nu)
{
 ...
 73d:	e8 ee fe ff ff       	call   630 <free>
  return freep;
 742:	8b 15 70 0a 00 00    	mov    0xa70,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 764:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 767:	89 15 70 0a 00 00    	mov    %edx,0xa70
      return (void*)(p + 1);
 ...
 77c:	eb e9                	jmp    767 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 77e:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 785:	0a 00 00 
    base.s.size = 0;
 788:	ba 74 0a 00 00       	mov    $0xa74,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 78d:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 794:	0a 00 00 
    base.s.size = 0;
 797:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 79e:	00 00 00 
